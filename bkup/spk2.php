            ...
            <tr style="text-align: center;">
              ...
              <?php 
                  if($row['tgl_mulai_real'] != NULL){
                    ?>
                    <a href="detailRealisasiBahan.php?id=<?php echo $row['id']; ?>" class="btn btn-iconed btn-round btn-info btn-xs"><i class="fa fa-eye"></i> Lihat </a><?php
                  }
                  else{
                    ?>
                    <a href="#" class="btn btn-iconed btn-round btn-warning btn-xs" onclick="tglReal()"><i class="fa fa-eye"></i> Lihat </a><?php
                  } 
                ?>
              ...
              <td class="text-center">
                ...
                <a href="#modalHapus_<?php echo $row['id']; ?>" class="btn btn-round btn-danger btn-xs" data-toggle="modal">Hapus</a><br>
                <a href="#modalDetailSpk_<?php echo $row['id']; ?>" class="btn btn-round btn-iconed btn-success btn-xs" data-toggle="modal"><i class="fa fa-check-square-o"></i> Detail SPK </a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
...
<!-- Pengulangan query, di while lg, modalnya ga kebaca -->
  <?php
  $sqlModal = "SELECT spk.idSpk as spk, nj.idJual as nota_jual, nj.tanggal as tanggal_nota, spk.tgl_spk as tglSpk, spk.tgl_perencanaan as tglRencana, spk.rencana_produksi as rencana, spk.status as status, p.namaPelanggan as pelanggan, b.nama as nama_barang, spk.tgl_mulai_real as tgl_mulai_real, spk.tgl_selesai_real as tgl_selesai_real, spk.hasil_produksi as hasil_produksi
    FROM barang b inner join spk
      on b.idBarang = spk.barang_idBarang
    inner join nota_jual nj
      on spk.nota_jual_idJual = nj.idJual
            ...
            <form action="action_ubah.php?cmd=ubahSPK" method="POST" role="form">
              <div class="row">
                ...
                <p><strong> Tanggal Rencana Selesai </strong></p>
                    <div class="input-group">
                    <input type="date" name="uRencanaSelesai" min="<?php echo date('Y-m-d'); ?>" class="form-control" value="<?php echo $rowModal['tglRencana']; ?>">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  </div><br>    
                </div>         
              </div>
...
<div class="modal fade" id="modalDetailSpk_<?php echo $rowModal['spk']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
        ...
        <div class="widget-content">
          <div class="modal-body">
            <form action="action_ubah.php?cmd=ubahRealisasiSPK" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                ...
                ?>
                <?php 
                  if($rowModal['tgl_selesai_real'] != NULL){
                    ?>
...
<script type="text/javascript">
    ...
    function tglReal() {
      alert("Isi 'Tanggal Mulai Real' dahulu, di Detail SPK");
    }
