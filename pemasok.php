  ...
  <a href="#" class="widget-control widget-control-minimize" data-toggle="tooltip" data-placement="top" title="" data-original-title="Perkecil / Perbesar"><i class="fa fa-chevron-down"></i></a>
      ...
      <div class="widget-content">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
          <?php
          $sql = "SELECT * FROM pemasok where deleted=0 order by idSupplier desc";
          ...
          ?>
            <tr>
              ...
              <td class="text-right">
                <a href="detailPemasok.php?id=<?php echo $row['idSupplier']; ?>" class="btn btn-round btn-info btn-xs">Detail</a>
                <a href="#modalUbah_<?php echo $row['idSupplier']; ?>" class="btn btn-round btn-default btn-xs" data-toggle="modal">Ubah</a>
                <a href="#modalHapus_<?php echo $row['idSupplier']; ?>" class="btn btn-round btn-danger btn-xs" data-toggle="modal">Hapus</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
...
<!-- Pengulangan query, di while lg, modalnya ga kebaca -->
  <?php
  $sql = "SELECT * FROM pemasok order by idSupplier desc";
  $result = mysqli_query($link, $sql);
  if(!$result){
      die("<br/>SQL error_log(message)r : " . $sql);
  }
  ...
  while ($row = mysqli_fetch_array($result)) {
      $no++;
  ?>
  <div class="modal fade" id="modalUbah_<?php echo $row['idSupplier']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
          ...
          <h3><i class="fa fa-ok-circle"></i> <strong>UBAH PEMASOK: </strong> <?php echo $row['nama']; ?></h3>
        </div>
        <div class="widget-content">
          <div class="modal-body">
            <form action="action_ubah.php?cmd=ubahPemasok" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                    <label>Nama Pemasok</label>
              ...
              <div class="text-right">
              <input type="hidden" name="uID" value= "<?php echo $row['idSupplier']; ?>">
...
<div class="modal fade" id="modalHapus_<?php echo $row['idSupplier']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
          ...
          <h3><i class="fa fa-ok-circle"></i> <strong>HAPUS PEMASOK: </strong> <?php echo $row['nama']; ?></h3>
        </div>
        <div class="widget-content">
          <div class="modal-body">
            <form action="action_hapus.php?cmd=hapusPemasok" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="alert alert-warning alert-dismissable bottom-margin">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
                  <i class="fa fa-exclamation-circle"></i> <strong>Peringatan!</strong> Anda akan menghapus Pemasok : <u><?php echo $row['nama'];?></u>. Data yang dihapus tidak dapat dikembalikan lagi.
                  </div>
                </div>
