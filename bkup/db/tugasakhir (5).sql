...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2018 at 03:30 PM
...
(3, 'Tepung Gaplek: Premium', 700000, 288, 1),
...
INSERT INTO `jadwalproduksi` (`idJadwalproduksi`, `tgl_mulai`, `tgl_selesai`, `tgl_mulai_real`, `tgl_selesai_real`, `keterangan`, `biaya_lain`, `status_mesin`, `hargaperkwh`, `listrik_idListrik`, `spk_idSpk`, `prosesproduksi_idProsesproduksi`) VALUES
(102, '2018-09-26', '2018-09-27', '2018-09-27', '2018-10-12', 'asdas', 223, 2, 0, 1, 12, 3),
(103, '2018-09-26', '2018-09-26', '2018-09-27', '2018-10-10', 'asd', 22, 3, 0, 1, 12, 12),
(104, '2018-09-26', '2018-09-26', '2018-09-27', '2018-10-17', 'qwe', 23, 2, 0, 1, 12, 13),
(105, '2018-09-26', '2018-09-26', '2018-09-27', '2018-10-31', '23', 23, 1, 0, 1, 12, 8),
(114, '2018-10-10', '2018-10-10', '2018-10-10', '2018-10-11', '', 0, 0, 0, 1, 14, 15),
(115, '2018-10-10', '2018-10-10', '2018-10-10', '2018-10-11', '', 0, 0, 0, 1, 14, 17),
(116, '2018-10-10', '2018-10-10', '2018-10-10', '2018-10-27', '', 0, 0, 0, 1, 14, 14),
(117, '2018-10-10', '2018-10-10', '2018-10-10', '2018-10-31', '', 0, 1, 0, 1, 14, 16);
...
(3, 'Mengeringkan Kerupuk', 5, 1, 2, 1),
(8, 'Mengirimkan Kerupuk', 2, 4, 1, 1),
(12, 'Mengemas Kerupuk', 2, 2, 3, 1),
(13, 'Membuat Adonan', 2, 3, 2, 1),
(14, 'Mengeringkan Kerupuks', 23, 3, 1, 2),
(15, 'Membuat adonan', 1, 1, 0, 2),
(16, 'Mengemas Kerupuk', 1, 4, 1, 2),
(17, 'Mencampur adonan', 1, 2, 0, 2);
...
(2, '2018-07-29', '2018-08-17', NULL, NULL, 55, NULL, 0, 1, 1, 1),
(5, '2018-08-07', '2018-08-09', NULL, NULL, 2323, NULL, 0, 1, 1, 1),
(6, '2018-08-07', '2018-08-31', NULL, NULL, 69, NULL, 0, 8, 2, 1),
(7, '2018-08-07', '2018-09-03', '2018-10-06', '2018-10-13', 51, 0, 0, 1, 1, 0),
(8, '2018-08-07', '2018-08-30', NULL, NULL, 69, NULL, 0, 7, 2, 1),
(9, '2018-08-07', '2017-11-25', '2018-10-10', NULL, 23, 0, 0, 8, 1, 0),
(10, '2018-08-07', '2018-08-31', NULL, NULL, 51, NULL, 0, 3, 2, 1),
(11, '2018-08-10', '2018-10-10', NULL, NULL, 12, NULL, 0, 1, 2, 1),
(12, '2018-08-16', '2018-08-31', '2018-09-28', '2018-10-31', 12, 14, 1, 1, 2, 0),
(14, '2018-09-13', '2018-09-21', '2018-10-11', '2018-10-31', 5, 5, 1, 2, 1, 0),
(15, '2018-09-28', '2018-09-29', '2018-09-28', '2018-09-28', 20, 15, 0, 4, 1, 1);
...
--
ALTER TABLE `jadwalproduksi`
  MODIFY `idJadwalproduksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
--
...
--
ALTER TABLE `nota_beli`
  MODIFY `idBeli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
--
...
--
ALTER TABLE `prosesproduksi`
  MODIFY `idProsesproduksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `spk`
  MODIFY `idSpk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
