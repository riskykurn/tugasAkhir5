...
<div class="all-wrapper fixed-header left-menu">
  ...
  <ul>
    ...
    <li class='current'><a href="mesin.php">Mesin</a></li>
  ...
  <a href="#" class="widget-control widget-control-minimize" data-toggle="tooltip" data-placement="top" title="" data-original-title="Perkecil / Perbesar"><i class="fa fa-chevron-down"></i></a>
            ...
            <h3><i class="fa fa-plus-circle"></i> Tambah Mesin</h3>
          </div>
          <div class="widget-content">
            <form action="action_tambah.php?cmd=tambahMesin" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Watt</label>
                    <input type="number" min="0" name="uWatt" class="form-control">
                  </div>
                </div>
              </div>
  ...
  <a href="#" class="widget-control widget-control-minimize" data-toggle="tooltip" data-placement="top" title="" data-original-title="Perkecil / Perbesar"><i class="fa fa-chevron-down"></i></a>
        ...
        <h3><i class="fa fa-cogs"></i><strong> Data Mesin</strong></h3>
      </div>
      <div class="widget-content">
        ...
        <table class="table table-bordered table-hover">
          ...
          <?php
          require 'db.php'; 
          $sql = "SELECT * FROM mesin order by idMesin desc";
          ...
          ?>
            <tr>
              ...
              <td class="text-right">
                <a href="#modalUbah_<?php echo $row['idMesin']; ?>" class="btn btn-round btn-default btn-xs" data-toggle="modal">Ubah</a>
                <a href="#modalHapus_<?php echo $row['idMesin']; ?>" class="btn btn-round btn-danger btn-xs" data-toggle="modal">Hapus</a>
              </td>
        ...
        <div class="text-right">
        <?php if($r_data2['idBarang']!=8){
        ?><a href="#modalBB" class="btn btn-iconed btn-success" data-toggle="modal"><i class="fa fa-check-circle"></i> Validasi </a> 
        <span class="help-block" style="font-weight: bold">*Jangan lupa klik apabila data pembelian sudah benar</span><?php } ?>

        <?php if($r_data2['idBarang']==8){
        ?><a href="#modalBB" class="btn btn-iconed btn-success" data-toggle="modal"><i class="fa fa-check-circle"></i> Munculkan </a> 
        <span class="help-block" style="font-weight: bold">*Jangan lupa klik apabila data pembelian sudah benar</span><?php } ?>
        
        <?php if($r_data2['idBarang']==8){
        ?><a href="#" class="btn btn-iconed btn-primary" data-toggle="modal"><i class="fa fa-check-circle"></i> Telah Tervaladasidasi </a>
    ...
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
          ...
          <h3><i class="fa fa-ok-circle"></i> <strong> PENGGUNAAN BAHAN BAKU </h3>
        </div>
        <div class="widget-content">
          <div class="modal-body">
            <form action="action_tambah.php?cmd=realisasiBB" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label> Rencana Produksi (Bal) </label>
                    <input type="number" min="0" value= "<?php echo $r_data['rencana']; ?>" name="uRencanaProduksi" class="form-control" disabled="disabled">
                  </div> 
                </div> 
                <?php
                require 'db.php'; 
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Jumlah</label>
                    <input type="number" name="uJumlah" class="form-control">
                  </div>
                </div>
                <?php } ?>
    ...
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
          ...
          <h3><strong> Resep dari : </strong><?php echo $r_data2['nama_barang']; ?></h3>
        </div>
        <div class="widget-content">
          <div class="modal-body">
            <div class="row">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT b.idBarang as idBarang, bb.idBB as idBB ,b.nama as nama_barang, bb.nama as nama_bb, s.nama as satuan, mn.jumlah as jumlah
                        ...
                        inner join satuan s
                          on bb.idSatuan = s.idSatuan
                        where b.idBarang=8"; //this isn't fix yet
                      $result = mysqli_query($link, $sql);
                      if(!$result){
                          die("<br/>SQL error_log(message)r : " . $sql);
                      }
...
<!-- Pengulangan query, di while lg, modalnya ga kebaca -->
  ...
  while ($row = mysqli_fetch_array($result)) {
      $no++;
  ?>
  <div class="modal fade" id="modalUbah_<?php echo $row['idMesin']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
          ...
          <h3><i class="fa fa-ok-circle"></i> <strong>UBAH MESIN: </strong> <?php echo $row['nama']; ?></h3>
        </div>
        <div class="widget-content">
          <div class="modal-body">
            <form action="action_ubah.php?cmd=ubahMesin" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Nama Mesin</label>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Watt</label>
                    <input type="number" min="0" name="uWatt" value= "<?php echo $row['watt']; ?>" class="form-control">
                  </div>
                </div>
              </div>
              <div class="text-right">
              <input type="hidden" name="uID" value= "<?php echo $row['idMesin']; ?>">
...
<div class="modal fade" id="modalHapus_<?php echo $row['idMesin']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalFormStyle1Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="widget widget-blue">
        <div class="widget-title">
          ...
          <h3><i class="fa fa-ok-circle"></i> <strong>HAPUS MESIN: </strong> <?php echo $row['nama']; ?></h3>
        </div>
        <div class="widget-content">
          <div class="modal-body">
            <form action="action_hapus.php?cmd=hapusMesin" method="POST" role="form">
              <div class="row">
                <div class="col-md-12">
                  <div class="alert alert-warning alert-dismissable bottom-margin">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
                  <i class="fa fa-exclamation-circle"></i> <strong>Peringatan!</strong> Anda akan menghapus Mesin : <u><?php echo $row['nama'];?></u>. Data yang dihapus tidak dapat dikembalikan lagi.
                  </div>
                </div>
                <div class="col-md-12 text-right">
                  <input type="hidden" name="uID" value= "<?php echo $row['idMesin']; ?>">
